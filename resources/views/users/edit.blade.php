      ...
      <div class="col-md-5">
        ...
        <form action="{{route('mypage')}}" method="post">
          ...
          <p class="text-center mb-4">
            <button type="submit" class="btn samuraimart-submit-button mt-3 w-100">保存</button>
          </p>
        </form>
        ...
        <div class="d-flex justify-content-start">
            <form action="{{route('mypage.destroy')}}" method="post">
                ...
                <div class="btn btn-outline-danger dashbord-delete-link" data-bs-toggle="modal" data-bs-target="#delete-user-confirm-modal">退会する</div>
